...
function CirclesSection() {
  ...
  return (
    ...
    <section aria-labelledby="circles-title" id="circles" className="py-4 lg:py-8">
      ...
      <div className="container">
        ...
        <p className="section-subtitle">
          Explore technical and non-technical tracks to enhance your skills and knowledge in innovation, project management, and more.
        </p>

        {/* Filter Buttons */}
        {/* Accessible tablist for filtering circle types */}
        <div className="flex flex-wrap justify-center gap-4 mt-6" role="tablist">
        ...
        <div
          id="circles-carousel"
          className="flex lg:flex-wrap items-center lg:justify-center gap-8 lg:gap-10 overflow-x-auto px-4 lg:px-0 py-8 lg:py-12 scrollbar-hidden snap-x snap-mandatory scroll-smooth"
          role="region"
