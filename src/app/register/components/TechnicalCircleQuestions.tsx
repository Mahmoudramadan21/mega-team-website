 ...
 */
export default function TechnicalCircleQuestions({
  register,
  errors,
  watch,
  ...
  const commonNote = (
    <div className="md:col-span-2 text-sm text-neutral-700 bg-neutral-50 p-5 rounded-xl border border-neutral-200 mb-6 leading-relaxed">
      ...
      في الجزء التقني، الأهم بالنسبة لنا هو المحاولة وبذل مجهود للوصول للمعلومة، مش شرط تكون كل الإجابات صحيحة 100%. اللي يهمنا أكتر هو طريقة تفكيرك ومحاولتك وحبك للتعلم والبحث.
      <br /><br />
      In the technical section, we care more about your effort and way of thinking than perfect answers. It’s okay if not all answers are correct. What matters most is that you try, search, and show how you approach problems and reach information.
    </div>
  );
    ...
    <div className="md:col-span-2 mt-8">
      ...
      <div className="space-y-1.5 mb-8">
        <label htmlFor="technicalCircle" className="form-label block">
          Which technical circle would you like to apply for? / أي دائرة تقنية تريد التقديم لها؟{' '}
        ...
        {errors.technicalCircle && (
          <p className="mt-1 text-sm text-primary-500">{errors.technicalCircle.message}</p>
        )}
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 mt-6">
          <div className="space-y-1.5">
            <label htmlFor="uiuxMeaning" className="form-label">
              What do you think UI/UX design means in your own words? / ما هو تصميم UI/UX من وجهة نظرك بكلماتك الخاصة؟
            </label>
            <textarea
              id="uiuxMeaning"
            ...
            />
            {errors.uiuxMeaning && (
              <p className="mt-1 text-sm text-primary-500">{errors.uiuxMeaning.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="uiuxTools" className="form-label">
              Have you ever used any design tools before (e.g., Figma, Adobe XD, Canva, Photoshop)? If yes, please mention which one(s)
            </label>
            <textarea
              id="uiuxTools"
              {...register('uiuxTools')}
            ...
            />
            {errors.uiuxTools && (
              <p className="mt-1 text-sm text-primary-500">{errors.uiuxTools.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.uiuxDifference && (
              <p className="mt-1 text-sm text-primary-500">{errors.uiuxDifference.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.uiuxPrinciples && (
              <p className="mt-1 text-sm text-primary-500">{errors.uiuxPrinciples.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="uiuxResearch" className="form-label">
              How do you usually do user research and usability testing? Give an example.
            </label>
            <textarea
              id="uiuxResearch"
            ...
            />
            {errors.uiuxResearch && (
              <p className="mt-1 text-sm text-primary-500">{errors.uiuxResearch.message}</p>
            )}
          </div>
        </div>
      )}
      ...
      {selectedTechCircle === 'Frontend' && (
        <div className="grid grid-cols-1 gap-6 mt-6">
          <div className="space-y-1.5">
            ...
            />
            {errors.frontendHtml && (
              <p className="mt-1 text-sm text-primary-500">{errors.frontendHtml.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.frontendHeadingTag && (
              <p className="mt-1 text-sm text-primary-500">{errors.frontendHeadingTag.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="frontendCssColor" className="form-label">
              How can you change the text color using CSS? (Give a simple example)
            </label>
            <textarea
              id="frontendCssColor"
            ...
            {errors.frontendCssColor && (
              <p className="mt-1 text-sm text-primary-500">{errors.frontendCssColor.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.frontendJsVars && (
              <p className="mt-1 text-sm text-primary-500">{errors.frontendJsVars.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.frontendReactComponents && (
              <p className="mt-1 text-sm text-primary-500">{errors.frontendReactComponents.message}</p>
            )}
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 gap-6 mt-6">
          <div className="space-y-1.5">
            ...
            {errors.backendClassObject && (
              <p className="mt-1 text-sm text-primary-500">{errors.backendClassObject.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.backendDeleteTruncate && (
              <p className="mt-1 text-sm text-primary-500">{errors.backendDeleteTruncate.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.backendSqlQuery && (
              <p className="mt-1 text-sm text-primary-500">{errors.backendSqlQuery.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.backendInterfaceAbstract && (
              <p className="mt-1 text-sm text-primary-500">{errors.backendInterfaceAbstract.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.backendValueReference && (
              <p className="mt-1 text-sm text-primary-500">{errors.backendValueReference.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="backendRest" className="form-label">
              What is REST in web development, and why is it important for backend systems?
            </label>
            <textarea
              id="backendRest"
            ...
            />
            {errors.backendRest && (
              <p className="mt-1 text-sm text-primary-500">{errors.backendRest.message}</p>
            )}
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 gap-6 mt-6">
          <div className="space-y-1.5">
            ...
            {errors.flutterWidget && (
              <p className="mt-1 text-sm text-primary-500">{errors.flutterWidget.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            />
            {errors.flutterState && (
              <p className="mt-1 text-sm text-primary-500">{errors.flutterState.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="flutterMainDart" className="form-label">
              What is the difference between main.dart and other Dart files in a Flutter project?
            </label>
            <textarea
              id="flutterMainDart"
            ...
            {errors.flutterMainDart && (
              <p className="mt-1 text-sm text-primary-500">{errors.flutterMainDart.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="flutterSyncAsync" className="form-label">
              Explain the difference between synchronous and asynchronous functions in Dart.
            </label>
            <textarea
              id="flutterSyncAsync"
            ...
            {errors.flutterSyncAsync && (
              <p className="mt-1 text-sm text-primary-500">{errors.flutterSyncAsync.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="flutterStateManagement" className="form-label">
              Explain the concept of State Management in Flutter. Mention at least 2 approaches.
            </label>
            <textarea
            ...
            {errors.flutterStateManagement && (
              <p className="mt-1 text-sm text-primary-500">{errors.flutterStateManagement.message}</p>
            )}
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 gap-6 mt-6">
          <div className="space-y-1.5">
            ...
            {errors.dataScienceTopics && (
              <p className="mt-1 text-sm text-primary-500">{errors.dataScienceTopics.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="dataScienceTime" className="form-label">
              How much time can you dedicate weekly to participating in the circle?
            </label>
            <textarea
              id="dataScienceTime"
            ...
            {errors.dataScienceTime && (
              <p className="mt-1 text-sm text-primary-500">{errors.dataScienceTime.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="dataScienceTools" className="form-label">
              Have you ever used any basic tools or software for data analysis (e.g., Excel)?
            </label>
            <textarea
              id="dataScienceTools"
            ...
            {errors.dataScienceTools && (
              <p className="mt-1 text-sm text-primary-500">{errors.dataScienceTools.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="dataSciencePythonLevel" className="form-label">
              What is your skill level in using Python libraries related to data science (like pandas, numpy, matplotlib)?
            </label>
            <textarea
            ...
            {errors.dataSciencePythonLevel && (
              <p className="mt-1 text-sm text-primary-500">{errors.dataSciencePythonLevel.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="dataScienceProject" className="form-label">
              Describe a complex data science project you have completed or contributed to
            </label>
            <textarea
            ...
            {errors.dataScienceProject && (
              <p className="mt-1 text-sm text-primary-500">{errors.dataScienceProject.message}</p>
            )}
          </div>
        </div>
      )}
      ...
      {selectedTechCircle === 'CS - Computer Science' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div className="space-y-1.5">
            ...
            {errors.csKeyword && (
              <p className="mt-1 text-sm text-primary-500">{errors.csKeyword.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.csArrayIndex && (
              <p className="mt-1 text-sm text-primary-500">{errors.csArrayIndex.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="csOopPrinciple" className="form-label">
              Which OOP principle is applied when data members are kept private and accessed via getter/setter methods?
            </label>
            <select
              id="csOopPrinciple"
            ...
            {errors.csOopPrinciple && (
              <p className="mt-1 text-sm text-primary-500">{errors.csOopPrinciple.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="csStlContainer" className="form-label">
              Which STL container automatically sorts elements and does not allow duplicates?
            </label>
            <select
              id="csStlContainer"
            ...
            {errors.csStlContainer && (
              <p className="mt-1 text-sm text-primary-500">{errors.csStlContainer.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="csTimeComplexity" className="form-label">
              What is the time complexity of inserting an element at the end of a vector?
            </label>
            <select
              id="csTimeComplexity"
            ...
            {errors.csTimeComplexity && (
              <p className="mt-1 text-sm text-primary-500">{errors.csTimeComplexity.message}</p>
            )}
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 gap-6 mt-6">
          <div className="space-y-1.5">
            <label htmlFor="baRole" className="form-label">
              How would you define the role of a Business Analyst in a software project?
            </label>
            <textarea
              id="baRole"
              {...register('baRole')}
            ...
            />
            {errors.baRole && (
              <p className="mt-1 text-sm text-primary-500">{errors.baRole.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="baDifference" className="form-label">
              In your opinion, how does Business Analysis differ from Business Development, and what skills are common between the two?
            </label>
            <textarea
              id="baDifference"
            ...
            />
            {errors.baDifference && (
              <p className="mt-1 text-sm text-primary-500">{errors.baDifference.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="baProject" className="form-label">
              Can you describe a project you worked on, your role in it, and the value you added as a Business Analyst?
            </label>
            <textarea
              id="baProject"
              {...register('baProject')}
            ...
            />
            {errors.baProject && (
              <p className="mt-1 text-sm text-primary-500">{errors.baProject.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="baRequirements" className="form-label">
              What are functional vs. non-functional requirements? Share examples of each from your experience?
            </label>
            <textarea
              id="baRequirements"
            ...
            {errors.baRequirements && (
              <p className="mt-1 text-sm text-primary-500">{errors.baRequirements.message}</p>
            )}
          </div>

          <div className="space-y-1.5">
            <label htmlFor="baDiagrams" className="form-label">
              Which types of diagrams (e.g., Use Case, ERD, Class, DFD) have you worked with, and how did you use them in your projects?
            </label>
            <textarea
              id="baDiagrams"
              {...register('baDiagrams')}
            ...
            />
            {errors.baDiagrams && (
              <p className="mt-1 text-sm text-primary-500">{errors.baDiagrams.message}</p>
            )}
          </div>
        </div>
      )}
